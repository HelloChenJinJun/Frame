package com.example.commonlibrary.widget.manager.video.nativeplayer;
...
public class DefaultVideoController extends VideoController implements View.OnClickListener {
    ...
    private RecyclerView clarityDisplay;
    ...
    private void initDefaultView() {
        ...
        clarityDisplay.setLayoutManager(new LinearLayoutManager(getContext()));
