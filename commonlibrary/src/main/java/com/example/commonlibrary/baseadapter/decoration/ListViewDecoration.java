...
public class ListViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListViewDecoration() {
        divider = BaseApplication.getInstance().getResources().getDrawable(R.drawable.recycler_divider);
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (divider != null) {
            ...
            BaseRecyclerAdapter baseRecyclerAdapter = (BaseRecyclerAdapter) parent.getAdapter();
            if (baseRecyclerAdapter.getHeaderViewCount() > position) {
                return;
            }
            int headerCount = ((BaseRecyclerAdapter) parent.getAdapter()).getHeaderViewCount();
