...
public class BaseWrappedViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseWrappedViewHolder setOnItemClickListener(View.OnClickListener listener) {
    ...
    public BaseWrappedViewHolder setOnItemChildClickListener(int id, View.OnClickListener listener) {
    ...
    public BaseWrappedViewHolder setOnItemLongClickListener() {
        if (itemView.isLongClickable())return this;
    ...
    public BaseWrappedViewHolder setOnItemChildLongClickListener(int id) {
        if (getView(id) != null&&!getView(id).isLongClickable()) {
    ...
    public BaseWrappedViewHolder setImageUrl(int id, String url) {
        setImageUrl(id, url,null);
        return this;
    }



    public BaseWrappedViewHolder setImageUrl(int id, String url,RequestOptions options) {
      setImageUrl(id, url, options,0.5f);
        return this;
    }
    ...
    public BaseWrappedViewHolder setImageUrl(int id, String url, int errorId, int placeHolderId) {
        ...
        return setImageUrl(id, url, options);
    }


    public BaseWrappedViewHolder setImageUrl(int id, String url,RequestOptions requestOptions, float thumbSize) {
        View view = getView(id);
//        if (requestOptions == null) {
//            requestOptions = new RequestOptions()
//                    .centerCrop()
//                    .error(R.drawable.custom_drawable_place_holder)
//                    .placeholder(R.drawable.custom_drawable_place_holder);
//        }
        if (view instanceof ImageView) {
            if (requestOptions!=null) {
                Glide.with(itemView.getContext()).load(url).thumbnail(thumbSize).apply(requestOptions.centerCrop()).into((ImageView) view);
            }else {
                Glide.with(itemView.getContext()).load(url).thumbnail(thumbSize).into((ImageView) view);
            }
        }
        return this;
    }
    ...
    public BaseWrappedViewHolder setTag(int id, String data) {
        getView(id).setTag(data);
        return this;
    }
}
