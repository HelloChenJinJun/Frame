...
public abstract class BaseApplication extends Application {
    ...
    private void initScreenAdapt() {
        ScreenAdaptManager.newBuild().designedHeight(getDesignedHeight())
                .designedWidth(getDesignedWidth()).build();
    }

    protected abstract int getDesignedHeight();
    protected abstract int getDesignedWidth();
